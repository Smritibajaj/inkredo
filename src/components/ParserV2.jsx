...
function ParserV2(props) {
    return (
        <React.Fragment>            
            <h2 className="titles">Parser V2 </h2>
            <p className="information m-b-20 m-t-20">This endpoint parsers and analysis a bank statement.</p>
            <CodeHeaders padding={'8px'} bgcolor={'#FFF3DC'} color={'black'} data={[` v2 supports parsing of statements that have multiple accounts in them. The response of v1 is wrapped in a account number key in v2.`]}  />
            <h2 className="m-b-20 m-t-20">Http Request</h2>
            <div className="m-b-20 m-t-20"><span className="highlighted">{`POST <URL>/api/v2/parser/`}</span></div>
            <Grid item xs={10}>
